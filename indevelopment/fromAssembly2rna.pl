...
system("prodigal -i $output_plasmid -o $genes_gfftmp -a $genes_faa -d $genes_fasta -f gff -q");
...
system("prodigal -i $output_chr -o $genes_gff1tmp -a $genes_faa1 -d $genes_fasta1 -f gff -q");
...
#print "\n\n\nprodigal -i $output_chr -o $gene_gbk1 -a $genes_faa1 -d $genes_fasta1\n\n\n";
#system("prodigal -i $output_chr -o $gene_gbk1 -a $genes_faa1 -d $genes_fasta1 -p meta -q");
system("prodigal -i $seq -o $genes_gff1tmp -a $genes_faa1 -d $genes_fasta1 -f gff -q");
